...
class Buku extends CI_Controller
{
    ...
    public function kategori()
    {
        ...
        $data['user'] = $this->ModelUser->cekData(['email' => $this->session->userdata('email')])->row_array();
        $data['kategori'] = $this->ModelBuku->getKategori()->result_array();
        $this->form_validation->set_rules('nama_kategori', 'Kategori', 'required|min_length[3]', ['required' => 'Kategori harus diisi']);
    ...
    public function ubahKategori()
    {
        ...
        $this->form_validation->set_rules('nama_kategori', 'Kategori', 'required|min_length[3]', ['required' => 'Nama kategori harus diisi', 'min_length' => 'Nama kategori terlalu pendek']);
    ...
    public function ubahBuku()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->ModelBuku->updateBuku($data, ['id_buku' =>
