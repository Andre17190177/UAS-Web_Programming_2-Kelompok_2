        ...
        <div class="modal-content">
            ...
            <form action="<?= base_url('donasi/donatur'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control form-control-user" id="telepon_donatur" name="telepon_donatur" placeholder="Masukkan Nomor Telepon/Hp">
                    </div>
                    <div class="form-group">
