            ...
            <table class="table table-hover">
                ...
                <tbody> <?php $a = 1;
                        ...
                        <tr>
                            ...
                            <td> <a href="<?= base_url('buku/ubahBuku/') . $b['id_buku']; ?>" class="badge badge-info"><i class="fas fa-edit"></i> Ubah</a> <a href="<?= base_url('buku/hapusbuku/') . $b['id_buku']; ?>" onclick="return confirm('Kamu yakin akan menghapus <?= $judul . ' ' . $b['judul_buku']; ?> ?');" class="badge badge-danger"><i class="fas fa-trash"></i> Hapus</a> </td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
